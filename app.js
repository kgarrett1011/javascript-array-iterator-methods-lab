...
firstLast = people.map(person => {
    ...
    return nameArray[1] + " " + nameArray[0] //return `${nameArray[1]} ${nameArray[0]}`
})
...
isAdultPresent = devs.some(person => person.year <= 2007);
...
isEveryone19OrOlder = devs.every(person => person.year <= 2006);
